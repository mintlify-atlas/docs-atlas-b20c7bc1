...
3. **File operations**: Limited file I/O capabilities without VFS support
4. **VFS dependency**: File operations like `fopen()`, `fread()`, `fwrite()`, `fscanf()` require `CONFIG_HAVE_VFS` to be enabled
</Warning>
